...
applyTo:
  ...
  - "**/AxClass/**Batch*.xml"
appliesWhen: User intent mentions batch job, SysOperation, RunBase, RunBaseBatch, scheduled batch, data migration script, DataContract class, batch controller, or SysRunnable.
---
