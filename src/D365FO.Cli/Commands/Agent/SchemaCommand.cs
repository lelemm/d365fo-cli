...
public sealed class SchemaCommand : Command<SchemaCommand.Settings>
{
    ...
    [
        ...
        C("lint", "Lint one X++/AOT XML file through the VS-extension bridge when available, or run the index-wide best-practice gate when no file is supplied.", ["[FILE]"], ["--backend", "--model", "--code-type", "--context", "--category", "--all-models", "--format", "--output"], ["lint"], true),
        C("designer kinds", "Show the static metadata-designer parent/child kind tree.", [], ["--full", "--parent-kind", "--output"], [], true),
        C("designer catalog", "Bridge-backed designer action catalog for a parent kind/node.", [], ["--parent-kind", "--node", "--output"], [], true),
        C("designer actions", "List valid designer actions for a concrete parent object/node.", [], ["--parent-kind", "--parent", "--model", "--file", "--node", "--output"], [], true),
        C("designer run", "Run one bridge-backed metadata-designer action.", ["<ACTION_ID>"], ["--parent-kind", "--parent", "--model", "--file", "--node", "--properties", "--set", "--dry-run", "--out", "--overwrite", "--output"], [], true),
        C("designer properties", "List readable/writable properties for a concrete object or selected designer node.", [], ["--parent-kind", "--parent", "--model", "--file", "--node", "--output"], [], true),
        C("designer property-options", "List dropdown-style options for one property.", [], ["--parent-kind", "--parent", "--model", "--file", "--node", "--property", "--output"], [], true),
        C("designer set-property", "Set one property on a concrete object or selected designer node.", [], ["--parent-kind", "--parent", "--model", "--file", "--node", "--property", "--value", "--dry-run", "--out", "--overwrite", "--output"], [], true),
        C("designer set-properties", "Set multiple properties on a concrete object or selected designer node.", [], ["--parent-kind", "--parent", "--model", "--file", "--node", "--properties", "--set", "--dry-run", "--out", "--overwrite", "--output"], [], true),
