...
public sealed class SchemaCommand : Command<SchemaCommand.Settings>
{
    ...
    [
        ...
        C("prepare change", "Single-round change context + grounding token.", ["<OBJECT>"], ["--method", "--goal", "--output"], [], true),
        C("prepare create", "Single-round new-object context + grounding token.", ["<NAME>"], ["--type", "--field", "--goal", "--output"], [], true),
        ...
        C("find references", "Alias of `find refs`.", ["<NAME>"], ["--kind", "--model", "--limit", "--xref", "--output"], []),
